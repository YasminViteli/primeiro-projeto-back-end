...
const router = express.Router() //aqui estou configurando a primeira arte da rota
const cors = require('cors') // aqui estou trazendo o pacote cors que permite consumir essa api do front-end
const conectaBancoDeDados = require('./BancoDeDados') //aqui eu estou ligando o banco de dados
...
//GET
async function mostraMulheres(resquesti,response) {
    try {
